...
//    }
    ...
    public ArticleDto create(Long memberId, ArticleForm articleForm) {
        ...
        Article article = Article.builder()
                ...
                .member(member)
                .bookIsbn(articleForm.getBookIsbn())
                .bookTitle(articleForm.getBookTitle())
                .bookAuthor(articleForm.getBookAuthor())
                .bookPublisher(articleForm.getBookPublisher())
                .bookCoverUrl(articleForm.getBookCoverUrl())
                .build();
    ...
    private ArticleDto mapToArticleDto(Article article) {
        return ArticleDto.builder()
                ...
                .email(article.getMember().getEmail())                // --- DTO 매핑에 책 정보 추가 ---
                .bookIsbn(article.getBookIsbn())
                .bookTitle(article.getBookTitle())
                .bookAuthor(article.getBookAuthor())
                .bookPublisher(article.getBookPublisher())
                .bookCoverUrl(article.getBookCoverUrl())
                // ---------------------------
                .build();
